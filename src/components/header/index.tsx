...
const Header = () => (
  <header className={tw(headerStyle)}>
    <div className={tw(`max-w-6xl mx-auto py-16 px-14 sm:px-6 lg:px-8 lg:pt-32 `)}>
      <h1 className={tw(`font-sans font-bold text-4xl md:text-5xl lg:text-8xl text-center leading-snug text-gray-800`)}>
      Grow your business with growth-hacking
      </h1>
      <div className={tw(`max-w-xl mx-auto`)}>
        <p className={tw(`mt-10 text-gray-500 text-center text-xl lg:text-3xl `)}>
         Gain new skills in data-driven growth marketing to beat the competition. 
        </p>
      </div>
    ...
    <div className={tw(`flex justify-center w-full`)}>
      <div className={tw(`mt-4 w-full`)}>
        <p className={tw(`font-mono uppercase text-center font-medium text-sm text-gray-600`)}>These folks will vouch for us</p>
