  ...
  <section>
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      ...
      <div className={tw(`max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40`)}>
        <h1 className={tw(`text-white text-4xl lg:text-7xl font-bold text-center`)}>What customers say about us</h1>
        <p className={tw(`text-white text-gray-400 text-center text-xl mt-12`)}>
          Don’t just take our word for it — see how our customers grow their business.
        </p>
          ...
          <div className={tw(`w-full flex flex-wrap justify-around`)}>
            ...
            <span
              className={tw(
                ...
                text-dad-blue cursor-pointer z-30 hover:text-dad-blue-dark`,
              )}
            >
              Bekijk alle reviews
